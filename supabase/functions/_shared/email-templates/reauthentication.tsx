    ...
    <Body style={main}>
      <Container style={wrapper}>
        ...
        <Section style={body}>
          ...
          <Text style={text}>
            To confirm your identity, please use the verification code below. This code will expire shortly for your security.
          </Text>
          <Section style={codeBox}>
            <Text style={codeStyle}>{token}</Text>
          </Section>
          <Text style={trustText}>🔒 Secure & encrypted verification.</Text>
        </Section>
        <Section style={footer}>
          ...
          <Text style={footerDisclaimer}>If you didn't request this code, you can safely ignore this email.</Text>
        </Section>
      </Container>
    </Body>
  </Html>
...
const codeBox = { textAlign: 'center' as const, margin: '24px 0', backgroundColor: '#f9fafb', borderRadius: '10px', padding: '20px', border: '1px solid #e5e7eb' }
const codeStyle = { fontFamily: "'SF Mono', 'Courier New', monospace", fontSize: '32px', fontWeight: '700' as const, color: '#3CB371', letterSpacing: '6px', margin: '0' }

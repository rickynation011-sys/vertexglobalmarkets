...
export const InviteEmail = ({ siteName, siteUrl, confirmationUrl }: InviteEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>You've been invited to join Vertex Global Markets</Preview>
    <Body style={main}>
      <Container style={wrapper}>
        ...
        <Section style={body}>
          ...
          <Text style={text}>
            You've been invited to join Vertex Global Markets — a next-generation trading and investment platform. Click the button below to accept your invitation and create your account.
          </Text>
          <Section style={buttonContainer}>
            <Button style={button} href={confirmationUrl}>Accept Invitation</Button>
          </Section>
          <Text style={trustText}>🔒 Secure & encrypted invitation link.</Text>
        </Section>
        <Section style={footer}>
          ...
          <Text style={footerDisclaimer}>If you weren't expecting this invitation, you can safely ignore this email.</Text>
        </Section>
      </Container>
    </Body>
  </Html>

...
export const MagicLinkEmail = ({ siteName, confirmationUrl }: MagicLinkEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your secure login link for Vertex Global Markets</Preview>
    <Body style={main}>
      <Container style={wrapper}>
        ...
        <Section style={body}>
          ...
          <Text style={text}>
            Click the button below to securely log in to your Vertex Global Markets account. This link will expire shortly for your protection.
          </Text>
          <Section style={buttonContainer}>
            <Button style={button} href={confirmationUrl}>Log In to Your Account</Button>
          </Section>
          <Text style={trustText}>🔒 Secure & encrypted authentication link.</Text>
        </Section>
        <Section style={footer}>
          ...
          <Text style={footerDisclaimer}>If you didn't request this link, you can safely ignore this email.</Text>
        </Section>
      </Container>
    </Body>
  </Html>

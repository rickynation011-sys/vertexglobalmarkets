...
export const RecoveryEmail = ({ siteName, confirmationUrl }: RecoveryEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Reset your password for Vertex Global Markets</Preview>
    <Body style={main}>
      <Container style={wrapper}>
        ...
        <Section style={body}>
          ...
          <Text style={text}>
            We received a request to reset your password for your Vertex Global Markets account. To choose a new password, please click the button below.
          </Text>
          <Text style={text}>
          ...
          <Text style={trustText}>🔒 This is a secure, encrypted link.</Text>
        </Section>
        <Section style={footer}>
          ...
          <Text style={footerDisclaimer}>If you didn't request a password reset, you can safely ignore this email. Your password will not be changed.</Text>
        </Section>
      </Container>
    </Body>
  </Html>

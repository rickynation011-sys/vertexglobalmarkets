...
const KycRejectedEmail = ({ name, reason }: Props) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your identity verification requires attention — {SITE_NAME}</Preview>
    <Body style={main}>
      <Container style={wrapper}>
        ...
        <Section style={body}>
          <Heading style={h1}>Verification Not Approved</Heading>
          <Text style={text}>{name ? `Hello ${name},` : 'Hello,'}</Text>
          <Text style={text}>
            Unfortunately, your identity verification (KYC) could not be approved at this time.
          </Text>
          {reason && (
          ...
          <Text style={text}>
            You may resubmit your documents with the corrections noted above. If you believe this was an error, please contact our support team.
          </Text>
          <Section style={buttonContainer}>
            <Button style={button} href={`${SITE_URL}/dashboard/kyc`}>Resubmit Documents</Button>
          </Section>
        </Section>
...
export const template = {
  ...
  previewData: { name: 'John', reason: 'Document was blurry or unreadable' },

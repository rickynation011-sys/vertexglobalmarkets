...
interface Props { userName?: string; userEmail?: string; country?: string; registeredAt?: string }

const AdminNewRegistrationEmail = ({ userName, userEmail, country, registeredAt }: Props) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>New user registered — {SITE_NAME}</Preview>
    <Body style={main}>
...
export const template = {
  ...
  previewData: { userName: 'Jane Doe', userEmail: 'jane@example.com', country: 'United States', registeredAt: new Date().toISOString() },
...
const infoText = { fontSize: '14px', color: '#1e40af', margin: '0 0 6px', lineHeight: '1.6' }

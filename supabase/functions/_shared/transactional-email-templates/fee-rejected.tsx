  ...
  <Html lang="en" dir="ltr">
    ...
    <Body style={main}>
      <Container style={wrapper}>
        ...
        <Section style={body}>
          <Heading style={h1}>Fee Payment Update</Heading>
          <Text style={text}>{name ? `Hello ${name},` : 'Hello,'}</Text>
          <Text style={text}>
            Your processing fee payment could not be verified at this time. This may be due to invalid or unclear proof of payment.
          </Text>
          <Section style={warningBox}>
            <Text style={warningText}>Please resubmit valid proof of payment to proceed with your withdrawal request.</Text>
          </Section>
          <Section style={buttonContainer}>
            <Button style={button} href={`${SITE_URL}/dashboard/fee-payment`}>Resubmit Proof</Button>
          </Section>
        </Section>
...
const warningBox = { backgroundColor: '#fef2f2', borderRadius: '10px', padding: '16px 20px', margin: '16px 0', border: '1px solid #fecaca' }
const warningText = { fontSize: '14px', color: '#991b1b', margin: '0', lineHeight: '1.6' }

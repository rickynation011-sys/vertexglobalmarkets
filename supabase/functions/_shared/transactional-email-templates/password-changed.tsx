...
const PasswordChangedEmail = ({ name }: Props) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your password was changed — {SITE_NAME}</Preview>
    <Body style={main}>
      <Container style={wrapper}>
        ...
        <Section style={body}>
          ...
          <Text style={text}>
            Your account password has been successfully changed. If you made this change, no further action is needed.
          </Text>
          <Section style={warningBox}>
            <Text style={warningText}>⚠️ If you did not make this change, please contact our support team immediately and secure your account.</Text>
          </Section>
          <Section style={buttonContainer}>
            <Button style={button} href={`mailto:${SUPPORT_EMAIL}`}>Contact Support</Button>
          </Section>
        </Section>
...
const warningBox = { backgroundColor: '#fffbeb', borderRadius: '10px', padding: '16px 20px', margin: '16px 0', border: '1px solid #fde68a' }
const warningText = { fontSize: '14px', color: '#92400e', margin: '0', lineHeight: '1.6' }

...
const plans = [
  { name: "Conservative Growth", icon: Shield, returns: "4-6%", risk: "Low", min: 500, duration: 30, description: "Stable returns through diversified bonds, ETFs, and blue-chip stocks.", features: ["AI Risk Management", "Auto-rebalancing", "Daily reports"], popular: false },
  { name: "Balanced Portfolio", icon: Target, returns: "6-9%", risk: "Medium", min: 2000, duration: 30, description: "Mix of growth stocks, forex, and crypto for balanced risk-reward.", features: ["Multi-asset exposure", "Smart hedging", "Weekly analytics"], popular: true },
                  ...
                  {activeInvestments.map((inv) => {
                    ...
                    return (
                      <tr key={inv.id} className="border-b border-border/50 last:border-0">
                        ...
                        <td className="py-3 text-success">+{Number(inv.return_pct).toFixed(1)}%</td>
